...
export class CommunicationService {
  ...
  secureCall<T>(token: Jwt, connection: Connection, body: any = {}, params: { [key: string]: string | number } = {}, queryParams: { [key: string]: string | number } = {}, headers? : HttpHeaders): Promise<T> {
    let url = connection.url;
